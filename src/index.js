...
var throttle = function (workers, tasks) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queue = __spreadArray([], tasks, true);
                results = [];
                workersPromises = Array.from({ length: workers }).map(function () { return processTask(queue, results); });
                return [4 /*yield*/, Promise.all(workersPromises)];
            case 1:
                _a.sent();
